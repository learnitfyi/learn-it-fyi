      ...
      return(
         <div id="signup">
            ...
            <form>
              ...
              <input type="password" id="password1" value="" placeholder="Create a Password" required />
              <label class="hidden" for="password2">Re-Enter Password</label>
              <input type="password" id="password2" value="" placeholder="Re-Enter Password" required />
